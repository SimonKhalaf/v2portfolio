  ...
  return (
    <div className="about-container">
      ...
      <div className="aboutcontent">
        ...
        <br /><br />
        I mainly use HTML, CSS, JavaScript, and React for coding. I've worked on small projects to improve my skills and I work part-time as an IT manager for a sports club, which has provided me with a broad understanding of various aspects of technology and leadership</p>
        </div>
      </div>
    </div>
  );
